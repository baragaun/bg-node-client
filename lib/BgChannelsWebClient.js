...
class BgChannelsWebClient {
    ...
    generateMockChannel(attributes, userCount, messageCount, users, messages) {
        return index_js_1.default.factories.channel(attributes, userCount, messageCount, users, messages);
    }
    generateMockUser(attributes) {
        return index_js_1.default.factories.user(attributes);
    }
    /**
