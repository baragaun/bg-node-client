...
(function (BgListenerTopic) {
    ...
    BgListenerTopic["channelMessage"] = "channelMessage";
...
////////////////////////////////////////////////////////////////////////////////////////////////////
// NATS
export var ChannelEventReason;
(function (ChannelEventReason) {
    ChannelEventReason["archived"] = "archived";
    ChannelEventReason["deleted"] = "deleted";
    ChannelEventReason["suspended"] = "suspended";
    ChannelEventReason["unarchived"] = "unarchived";
    ChannelEventReason["unsuspended"] = "unsuspended";
    ChannelEventReason["updated"] = "updated";
    ChannelEventReason["invitationCreated"] = "invitationCreated";
    ChannelEventReason["invitationUpdated"] = "invitationUpdated";
    ChannelEventReason["invitationDeleted"] = "invitationDeleted";
    ChannelEventReason["invitationDismissedFromInboxByRecipient"] = "invitationDismissedFromInboxByRecipient";
    ChannelEventReason["invitationDismissedFromInboxBySender"] = "invitationDismissedFromInboxBySender";
    ChannelEventReason["messageCreated"] = "messageCreated";
    ChannelEventReason["messageUpdated"] = "messageUpdated";
    ChannelEventReason["messageDeleted"] = "messageDeleted";
    ChannelEventReason["participantCreated"] = "participantCreated";
    ChannelEventReason["participantUpdated"] = "participantUpdated";
    ChannelEventReason["participantDeleted"] = "participantDeleted";
    ChannelEventReason["userSuspended"] = "userSuspended";
    ChannelEventReason["userUnsuspended"] = "userUnsuspended";
})(ChannelEventReason || (ChannelEventReason = {}));
export var ChannelMessageEventReason;
(function (ChannelMessageEventReason) {
    ChannelMessageEventReason["created"] = "created";
    ChannelMessageEventReason["deleted"] = "deleted";
    ChannelMessageEventReason["seen"] = "seen";
    ChannelMessageEventReason["updated"] = "updated";
})(ChannelMessageEventReason || (ChannelMessageEventReason = {}));
export var EventType;
(function (EventType) {
    EventType["channel"] = "channel";
    EventType["channelMessage"] = "channelMessage";
    EventType["myUser"] = "myUser";
    EventType["user"] = "user";
})(EventType || (EventType = {}));
export var MyUserEventReason;
(function (MyUserEventReason) {
    MyUserEventReason["myUserCreated"] = "myUserCreated";
    MyUserEventReason["myUserDeleted"] = "myUserDeleted";
    MyUserEventReason["myUserUpdated"] = "myUserUpdated";
    MyUserEventReason["myUserSuspended"] = "myUserSuspended";
    MyUserEventReason["channelCreated"] = "channelCreated";
    MyUserEventReason["channelInvitationReceived"] = "channelInvitationReceived";
    MyUserEventReason["channelInvitationAccepted"] = "channelInvitationAccepted";
    MyUserEventReason["channelInvitationDeclined"] = "channelInvitationDeclined";
    MyUserEventReason["inboxUpdated"] = "inboxUpdated";
    MyUserEventReason["blockedByAnotherUser"] = "blockedByAnotherUser";
    MyUserEventReason["unblockedByAnotherUser"] = "unblockedByAnotherUser";
})(MyUserEventReason || (MyUserEventReason = {}));
/** NATS event reasons for messages related to other users, not MyUser.
 *
 */
export var UserEventReason;
(function (UserEventReason) {
    UserEventReason["channelCreated"] = "channelCreated";
    UserEventReason["channelDeleted"] = "channelDeleted";
    UserEventReason["channelInvitationReceived"] = "channelInvitationReceived";
    UserEventReason["channelInvitationAccepted"] = "channelInvitationAccepted";
    UserEventReason["channelInvitationDeclined"] = "channelInvitationDeclined";
    UserEventReason["inboxUpdated"] = "inboxUpdated";
    UserEventReason["blockedByAnotherUser"] = "blockedByAnotherUser";
    UserEventReason["unblockedByAnotherUser"] = "unblockedByAnotherUser";
})(UserEventReason || (UserEventReason = {}));
