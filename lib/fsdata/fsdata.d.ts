declare const fsdata: {
    ...
    findById: <T extends import("../models/Model.js").Model = import("../models/Model.js").Model>(id: string, modelType: import("../enums.js").ModelType, selections?: any, options?: import("../types/FindObjectsOptions.js").FindObjectsOptions) => Promise<import("../index.js").QueryResult<T>>;
    ...
    channel: {
        ...
        findMyChannels: (filter?: import("../index.js").ChannelListFilter, match?: Partial<import("../index.js").Channel>, options?: import("../types/FindObjectsOptions.js").FindObjectsOptions, scope?: import("../index.js").ChannelMessageScope) => Promise<import("../index.js").QueryResult<import("../index.js").ChannelListItem>>;
    };
    channelInvitation: {
    ...
    walletItem: {
        createWalletItem: (props: Partial<import("../index.js").WalletItem>) => Promise<import("../index.js").QueryResult<import("../index.js").WalletItem>>;
    ...
    walletItemTransfer: {
        ...
        findWalletItemTransferRecipientInfoByTransferSlug: (transferSlug: string, transferSecret?: string | null) => Promise<import("../index.js").QueryResult<import("../index.js").WalletItemTransferRecipientInfo>>;
        ...
        updateWalletItemTransferShowOnlineFlag: (transferSlug: string, transferSecret: string, showOnline: boolean) => Promise<import("../index.js").QueryResult<void>>;
