...
export declare enum AdminTaskResult {
    Error = "error",
    Ok = "ok"
}
...
export declare enum FederatedIdentityProvider {
    Firebase = "firebase",
    None = "none"
}
...
export declare enum GroupRuleEventType {
...
export declare enum NotificationTemplateName {
...
export declare enum ObjectChangedEventType {
...
export type Query = {
    ...
    verifyWalletItemTransfer?: Maybe<WalletItem>;
};
...
export type QueryVerifyWalletItemTransferArgs = {
    transferSecret: Scalars['String']['input'];
    walletItemId: Scalars['String']['input'];
};
...
export declare enum ServiceRequestType {
    ...
    GraphQlQueryVerifyWalletItemTransfer = "graphQlQueryVerifyWalletItemTransfer",
    Unset = "unset"
}
...
export declare enum UserProfileRole {
    Both = "both",
    Mentee = "mentee",
    Mentor = "mentor",
    None = "none"
...
export declare enum UserSearchFieldOption {
    Any = "any",
    IsFalse = "isFalse",
    IsTrue = "isTrue",
    Match = "match"
...
export declare enum UserSearchSubscriptionType {
    Daily = "daily",
    Monthly = "monthly",
    None = "none",
    Weekly = "weekly"
