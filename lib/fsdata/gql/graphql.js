...
(function (AdminTaskType) {
    ...
    AdminTaskType["AssignAllContentConcernResolvedStatus"] = "assignAllContentConcernResolvedStatus";
    AdminTaskType["AssignDefaultPreferencesToAllUsers"] = "assignDefaultPreferencesToAllUsers";
    AdminTaskType["ClearAnalyticsSyncMetadataInMainDb"] = "clearAnalyticsSyncMetadataInMainDb";
    ...
    AdminTaskType["FillAllMm2ProfileIds"] = "fillAllMm2ProfileIds";
    ...
    AdminTaskType["MigrateEthnicity"] = "migrateEthnicity";
    ...
    AdminTaskType["ResetAllChannelWatermarkSeq"] = "resetAllChannelWatermarkSeq";
    ...
    AdminTaskType["UpdateEmbeddedGroupMembershipsOfAllUsers"] = "updateEmbeddedGroupMembershipsOfAllUsers";
...
export var ChannelChangedEventReason;
(function (ChannelChangedEventReason) {
    ChannelChangedEventReason["ChannelArchivedByParticipant"] = "channelArchivedByParticipant";
    ChannelChangedEventReason["ChannelCreated"] = "channelCreated";
    ChannelChangedEventReason["ChannelDeleted"] = "channelDeleted";
    ChannelChangedEventReason["ChannelSuspended"] = "channelSuspended";
    ChannelChangedEventReason["ChannelUnarchivedByParticipant"] = "channelUnarchivedByParticipant";
    ChannelChangedEventReason["ChannelUnsuspended"] = "channelUnsuspended";
    ChannelChangedEventReason["ChannelUpdated"] = "channelUpdated";
    ChannelChangedEventReason["InvitationAccepted"] = "invitationAccepted";
    ChannelChangedEventReason["InvitationArchived"] = "invitationArchived";
    ChannelChangedEventReason["InvitationCreated"] = "invitationCreated";
    ChannelChangedEventReason["InvitationDeclined"] = "invitationDeclined";
    ChannelChangedEventReason["InvitationDeleted"] = "invitationDeleted";
    ChannelChangedEventReason["InvitationReceived"] = "invitationReceived";
    ChannelChangedEventReason["InvitationSeen"] = "invitationSeen";
    ChannelChangedEventReason["InvitationStatusChanged"] = "invitationStatusChanged";
    ChannelChangedEventReason["InvitationSuspended"] = "invitationSuspended";
    ChannelChangedEventReason["InvitationUnarchived"] = "invitationUnarchived";
    ChannelChangedEventReason["InvitationUnsuspended"] = "invitationUnsuspended";
    ChannelChangedEventReason["InvitationUpdated"] = "invitationUpdated";
    ChannelChangedEventReason["MessageCreated"] = "messageCreated";
    ChannelChangedEventReason["MessageDeleted"] = "messageDeleted";
    ChannelChangedEventReason["MessageReceived"] = "messageReceived";
    ChannelChangedEventReason["MessageSeen"] = "messageSeen";
    ChannelChangedEventReason["MessageSuspended"] = "messageSuspended";
    ChannelChangedEventReason["MessageUnsuspended"] = "messageUnsuspended";
    ChannelChangedEventReason["MessageUpdated"] = "messageUpdated";
    ChannelChangedEventReason["ParticipantCreated"] = "participantCreated";
    ChannelChangedEventReason["ParticipantDeleted"] = "participantDeleted";
    ChannelChangedEventReason["ParticipantSuspended"] = "participantSuspended";
    ChannelChangedEventReason["ParticipantUnsuspended"] = "participantUnsuspended";
    ChannelChangedEventReason["ParticipantUpdated"] = "participantUpdated";
    ChannelChangedEventReason["UserSuspended"] = "userSuspended";
    ChannelChangedEventReason["UserUnsuspended"] = "userUnsuspended";
})(ChannelChangedEventReason || (ChannelChangedEventReason = {}));
export var ChannelChangedEventType;
(function (ChannelChangedEventType) {
    ChannelChangedEventType["ChannelArchivedByParticipant"] = "channelArchivedByParticipant";
...
export var FirebasePushNotificationPriority;
(function (FirebasePushNotificationPriority) {
    FirebasePushNotificationPriority["High"] = "high";
    FirebasePushNotificationPriority["Normal"] = "normal";
})(FirebasePushNotificationPriority || (FirebasePushNotificationPriority = {}));
...
(function (ModelType) {
    ...
    ModelType["AnalyticsVerification"] = "AnalyticsVerification";
    ...
    ModelType["ContentConcern"] = "ContentConcern";
    ModelType["ContentStatus"] = "ContentStatus";
    ModelType["ContentTag"] = "ContentTag";
    ModelType["CrashAlert"] = "CrashAlert";
    ModelType["DataDeletionRecord"] = "DataDeletionRecord";
...
export var RefreshUserInboxReason;
(function (RefreshUserInboxReason) {
    RefreshUserInboxReason["ChannelArchived"] = "channelArchived";
    RefreshUserInboxReason["ChannelCreated"] = "channelCreated";
    RefreshUserInboxReason["ChannelDeleted"] = "channelDeleted";
    RefreshUserInboxReason["ChannelSuspended"] = "channelSuspended";
    RefreshUserInboxReason["ChannelUnarchived"] = "channelUnarchived";
    RefreshUserInboxReason["ChannelUnsuspended"] = "channelUnsuspended";
    RefreshUserInboxReason["ChannelUpdated"] = "channelUpdated";
    RefreshUserInboxReason["InvitationAccepted"] = "invitationAccepted";
    RefreshUserInboxReason["InvitationArchived"] = "invitationArchived";
    RefreshUserInboxReason["InvitationCreated"] = "invitationCreated";
    RefreshUserInboxReason["InvitationDeclined"] = "invitationDeclined";
    RefreshUserInboxReason["InvitationDeleted"] = "invitationDeleted";
    RefreshUserInboxReason["InvitationDismissedFromInboxByRecipient"] = "invitationDismissedFromInboxByRecipient";
    RefreshUserInboxReason["InvitationDismissedFromInboxBySender"] = "invitationDismissedFromInboxBySender";
    RefreshUserInboxReason["InvitationReceived"] = "invitationReceived";
    RefreshUserInboxReason["InvitationSeen"] = "invitationSeen";
    RefreshUserInboxReason["InvitationStatusChanged"] = "invitationStatusChanged";
    RefreshUserInboxReason["InvitationSuspended"] = "invitationSuspended";
    RefreshUserInboxReason["InvitationUnarchived"] = "invitationUnarchived";
    RefreshUserInboxReason["InvitationUnsuspended"] = "invitationUnsuspended";
    RefreshUserInboxReason["InvitationUpdated"] = "invitationUpdated";
    RefreshUserInboxReason["MessageCreated"] = "messageCreated";
    RefreshUserInboxReason["MessageDeleted"] = "messageDeleted";
    RefreshUserInboxReason["MessageReceived"] = "messageReceived";
    RefreshUserInboxReason["MessageSeen"] = "messageSeen";
    RefreshUserInboxReason["MessageSuspended"] = "messageSuspended";
    RefreshUserInboxReason["MessageUnsuspended"] = "messageUnsuspended";
    RefreshUserInboxReason["MessageUpdated"] = "messageUpdated";
    RefreshUserInboxReason["ParticipantCreated"] = "participantCreated";
    RefreshUserInboxReason["ParticipantDeleted"] = "participantDeleted";
    RefreshUserInboxReason["ParticipantSuspended"] = "participantSuspended";
    RefreshUserInboxReason["ParticipantUnsuspended"] = "participantUnsuspended";
    RefreshUserInboxReason["ParticipantUpdated"] = "participantUpdated";
    RefreshUserInboxReason["Unknown"] = "unknown";
    RefreshUserInboxReason["UserSuspended"] = "userSuspended";
    RefreshUserInboxReason["UserUnsuspended"] = "userUnsuspended";
})(RefreshUserInboxReason || (RefreshUserInboxReason = {}));
...
(function (ServiceRequestType) {
    ServiceRequestType["GraphQlMutationAcceptWalletItemTransfer"] = "graphQlMutationAcceptWalletItemTransfer";
    ...
    ServiceRequestType["GraphQlMutationCreateAnalyticsVerification"] = "graphQlMutationCreateAnalyticsVerification";
    ...
    ServiceRequestType["GraphQlMutationCreateTrackingEvent"] = "graphQlMutationCreateTrackingEvent";
    ...
    ServiceRequestType["GraphQlMutationCreateWalletTransfer"] = "graphQlMutationCreateWalletTransfer";
    ServiceRequestType["GraphQlMutationDeclineWalletItemTransfer"] = "graphQlMutationDeclineWalletItemTransfer";
    ...
    ServiceRequestType["GraphQlMutationRefreshContentStatus"] = "graphQlMutationRefreshContentStatus";
    ...
    ServiceRequestType["GraphQlMutationRunAnalyticsVerification"] = "graphQlMutationRunAnalyticsVerification";
    ...
    ServiceRequestType["GraphQlMutationUpdateUpdateWalletItemTransferShowOnlineFlag"] = "graphQlMutationUpdateUpdateWalletItemTransferShowOnlineFlag";
    ...
    ServiceRequestType["GraphQlMutationUpdateWalletItemTransferPassword"] = "graphQlMutationUpdateWalletItemTransferPassword";
    ServiceRequestType["GraphQlMutationUpsertBackgroundTask"] = "graphQlMutationUpsertBackgroundTask";
    ServiceRequestType["GraphQlMutationUpsertUserTracking"] = "graphQlMutationUpsertUserTracking";
    ...
    ServiceRequestType["GraphQlQueryFindAnalyticsVerificationById"] = "graphQlQueryFindAnalyticsVerificationById";
    ...
    ServiceRequestType["GraphQlQueryFindMyChannelInvitations"] = "graphQlQueryFindMyChannelInvitations";
    ...
    ServiceRequestType["GraphQlQueryFindUserCmsByUserIdField"] = "graphQlQueryFindUserCmsByUserIdField";
    ...
    ServiceRequestType["GraphQlQueryFindWalletItemByTransferSlug"] = "graphQlQueryFindWalletItemByTransferSlug";
    ServiceRequestType["GraphQlQueryFindWalletItemTransferById"] = "graphQlQueryFindWalletItemTransferById";
    ServiceRequestType["GraphQlQueryFindWalletItemTransferByTransferSlug"] = "graphQlQueryFindWalletItemTransferByTransferSlug";
    ServiceRequestType["GraphQlQueryFindWalletItemTransferRecipientInfoByTransferSlug"] = "graphQlQueryFindWalletItemTransferRecipientInfoByTransferSlug";
    ...
    ServiceRequestType["GraphQlQueryVerifyWalletItemTransferPassword"] = "graphQlQueryVerifyWalletItemTransferPassword";
...
(function (TrackingEventType) {
    TrackingEventType["FirstAppLoad"] = "firstAppLoad";
    TrackingEventType["Unset"] = "unset";
    TrackingEventType["UserAcceptedInvitation"] = "userAcceptedInvitation";
    TrackingEventType["UserDeclinedInvitation"] = "userDeclinedInvitation";
    TrackingEventType["UserDeletedAccount"] = "userDeletedAccount";
    TrackingEventType["UserFinishedSignUp"] = "userFinishedSignUp";
    TrackingEventType["UserFinishedTraining"] = "userFinishedTraining";
    TrackingEventType["UserSentInvitation"] = "userSentInvitation";
    TrackingEventType["UserSentMessage"] = "userSentMessage";
    TrackingEventType["UserStartedSignUp"] = "userStartedSignUp";
    TrackingEventType["UserStartedTraining"] = "userStartedTraining";
})(TrackingEventType || (TrackingEventType = {}));
export var TrackingServiceType;
(function (TrackingServiceType) {
    TrackingServiceType["Google"] = "google";
    TrackingServiceType["Meta"] = "meta";
    TrackingServiceType["Unset"] = "unset";
})(TrackingServiceType || (TrackingServiceType = {}));
