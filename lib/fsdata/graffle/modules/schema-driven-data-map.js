...
const Mm2SynchronizerLogLevel = {
    k: 'enum',
    n: 'Mm2SynchronizerLogLevel',
};
const SyncActionTaken = {
    k: 'enum',
    n: 'SyncActionTaken',
};
...
const BgLatestUnseenChannelMessageInfo = {
    f: {
        userId: {},
        createdAt: {
            nt: DateTimeISO,
...
const Mm2SynchronizationResult = {
    f: {
        items: {
...
const Mm2SynchronizationResultItem = {
    f: {
        id: {},
        adminNotes: {},
        events: {
