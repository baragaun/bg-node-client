...
const FirebasePushNotificationPriority = {
    k: 'enum',
...
const ChannelChangedEventReason = {
    k: 'enum',
    n: 'ChannelChangedEventReason',
};
const RefreshUserInboxReason = {
    k: 'enum',
...
const PurchaseOrderItemListFilter = {
...
const ShoppingCartItemListFilter = {
...
const WalletItemTransferListFilter = {
...
const GiftCardDenominationInput = {
...
const GiftCardProductListFilter = {
...
const ProductCategoryListFilter = {
...
const MarketplaceServiceRecord = {
    f: {
        id: {},
        adminNotes: {},
        events: {
...
const UserInboxUpdatedAppEventData = {
    f: {
        serviceRequest: {
        // nt: ServiceRequest, <-- Assigned later to avoid potential circular dependency.
        },
