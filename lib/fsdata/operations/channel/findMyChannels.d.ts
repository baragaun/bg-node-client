...
declare const findMyChannels: (filter?: ChannelListFilter, match?: Partial<Channel>, options?: FindObjectsOptions, scope?: ChannelMessageScope) => Promise<QueryResult<ChannelListItem>>;
