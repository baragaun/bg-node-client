...
const createWalletItemTransfer = async (props) => {
    try {
        ...
        logger.debug('fsdata.createWalletItemTransfer received response.', { props, response: JSON.stringify(response) });
        ...
        logger.debug('fsdata.createWalletItemTransfer: finished.', { props, pollingResponse });
