declare const operations: {
    ...
    createChannelMessage: (channelMessage: Partial<import("../definitions.js").ChannelMessage>) => Promise<import("../definitions.js").MutateChannelResult<import("../definitions.js").ChannelMessage>>;
