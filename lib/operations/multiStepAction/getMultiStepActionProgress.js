...
const getMultiStepActionProgress = async (actionId, confirmToken, queryOptions) => {
    ...
    try {
        ...
        logger.debug('BgNodeClient.operations.multiStepAction.getMultiStepActionProgress: received response.', { actionProgress });
        if (!actionProgress) {
            logger.error('BgNodeClient.operations.multiStepAction.getMultiStepActionProgress: action not found.', { actionId, confirmToken });
