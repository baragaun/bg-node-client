...
const findWalletItems = async (filter, match, _selector, options, _queryOptions = defaultQueryOptions) => {
    try {
        ...
        // }
        const result = await fsdata.walletItem.findWalletItems(filter, match, options);
