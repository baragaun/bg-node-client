 ...
 * @param stores
 */
export declare function makeX3DHBundle(address: SignalClient.ProtocolAddress, stores: LibSignalStores | LibSignalMemStores): Promise<SignalClient.PreKeyBundle>;
/**
 ...
 * @param stores
 */
export declare function makePQXDHBundle(address: SignalClient.ProtocolAddress, stores: LibSignalStores | LibSignalMemStores): Promise<SignalClient.PreKeyBundle>;
export declare const sessionVersionTestCases: {
    suffix: string;
    makeBundle: typeof makeX3DHBundle;
