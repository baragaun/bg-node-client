...
export const blockUserForMeSpecHelper = async (userId, reasonTextId, notes, client) => {
    logger.debug('BgServiceApiCheck.blockUserForMe: calling API/blockUserForMe', { userId, reasonTextId, notes });
    const response = await client.operations.myUser.blockUserForMe(userId, reasonTextId, notes, { cachePolicy: CachePolicy.network });
    logger.debug('BgServiceApiCheck.blockUserForMe: received response from blockUserForMe', { updateUserResponse: response });
...
//# sourceMappingURL=blockUserForMe.specHelper.js.map