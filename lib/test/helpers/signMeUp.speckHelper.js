...
import { signMeOutSpeckHelper } from './signMeOut.speckHelper.js';
...
export const signMeUpSpeckHelper = async (props, signOut, client) => {
    ...
    if (signOut) {
        await signMeOutSpeckHelper(client);
    }
    return myUser;
};
//# sourceMappingURL=signMeUp.speckHelper.js.map