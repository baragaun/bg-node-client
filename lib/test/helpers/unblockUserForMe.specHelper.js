...
export const unblockUserForMeSpecHelper = async (userId, client) => {
    logger.debug('BgServiceApiCheck.blockUserForMe: calling API/blockUserForMe', { userId });
    ...
    expect(oldUserBlockCount).toBeGreaterThan(0);
    const response = await client.operations.myUser.unblockUserForMe(userId);
    ...
    return myUserFromCache1;
};
//# sourceMappingURL=unblockUserForMe.specHelper.js.map