...
export const createWalletItemSpecHelper = async (props, client) => {
    logger.debug('BgServiceApiCheck.createWalletItem: calling API/createWalletItem', { props });
    ...
    const response = await client.operations.walletItem.createWalletItem(props);
    logger.debug('BgServiceApiCheck.createWalletItem: received createWalletItem response', { response });
...
//# sourceMappingURL=createWalletItem.specHelper.js.map