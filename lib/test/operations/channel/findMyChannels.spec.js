...
describe.runIf(isFeatureEnabled('channels'))('operations.channel.findMyChannels', () => {
    ...
    test('returns the channels for the current user', async () => {
        ...
        const queryResultFromNetwork = await client.operations.channel.findMyChannels(undefined, { cachePolicy: CachePolicy.network });
        ...
        const queryResultFromLocal = await client.operations.channel.findMyChannels(undefined, { cachePolicy: CachePolicy.cache });
