...
describe.runIf(isFeatureEnabled('channels'))('operations.channel.findMyChannelsV2', () => {
    let client;
    beforeAll(async () => {
    ...
    test('returns the channels for the current user', async () => {
        ...
        const queryResultFromNetwork = await client.operations.channel.findMyChannelsV2(4, true, undefined, { cachePolicy: CachePolicy.network });
        ...
        const queryResultFromLocal = await client.operations.channel.findMyChannelsV2(4, true, undefined, { cachePolicy: CachePolicy.cache });
...
//# sourceMappingURL=findMyChannelsV2.spec.js.map