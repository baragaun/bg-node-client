...
describe('operations.channelMessage.findChannelMessages', () => {
    ...
    test('returns the channels for the current user', async () => {
        ...
        const queryResultFromNetwork = await client.operations.channelMessage.findChannelMessages(undefined, { channelId: channels[0].id }, undefined, undefined, { cachePolicy: CachePolicy.network });
