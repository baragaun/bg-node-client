            ...
            actionRun.addListener({
                ...
                onEvent: async (eventType, action) => {
                    ...
                    if (eventType === MultiStepActionEventType.notificationSent ||
                        ...
                        const sendNotificationResponse = await client.operations.multiStepAction.sendMultiStepActionNotification(actionId, NotificationMethod.email);
                        expect(sendNotificationResponse.error).toBeUndefined();
                        expect(sendNotificationResponse.object).toBeDefined();
                        expect(sendNotificationResponse.object.actionId).toBe(actionId);
