...
describe('operations.user.findUsers', () => {
    ...
    test('returns users', async () => {
        ...
        const queryResultFromNetwork = await client.operations.user.findUsers({ searchText: 'lipfumfpo' }, undefined, undefined, undefined, { cachePolicy: CachePolicy.network });
