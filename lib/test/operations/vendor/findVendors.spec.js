...
describe('operations.vendor.findVendors', () => {
    ...
    test('returns the gift card products', async () => {
        ...
        const vendorResponse = await client.operations.vendor.findVendors(undefined, undefined, undefined, undefined, { cachePolicy: CachePolicy.network });
        expect(vendorResponse.error).toBeUndefined();
        expect(vendorResponse.objects.length).toBeGreaterThan(10);
    });
}, { timeout: 60000 });
//# sourceMappingURL=findVendors.spec.js.map