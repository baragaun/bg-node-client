...
describe('operations.walletItem.updateWalletItem', () => {
    ...
    test('updates a wallet item', async () => {
        await createPurchaseOrderSpecHelper({}, chance.integer({ min: 3, max: 6 }), [], client);
        ...
        const findResult = await client.operations.findById(itemToUpdate.id, ModelType.WalletItem, { cachePolicy: CachePolicy.network });
...
//# sourceMappingURL=updateWalletItems.spec.js.map