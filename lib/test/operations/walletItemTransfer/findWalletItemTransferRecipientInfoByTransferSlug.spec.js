...
describe('operations.walletItemTransfer.findWalletItemTransferRecipientInfoByTransferSlug', () => {
    ...
    test('should find the created wallet item transfer', async () => {
        ...
        const resultNoSecret = await findWalletItemTransferRecipientInfoByTransferSlug(walletItemTransfer.transferSlug);
        ...
        const resultWithSecret = await findWalletItemTransferRecipientInfoByTransferSlug(walletItemTransfer.transferSlug, walletItemTransfer.transferSecret);
        ...
        const acceptResponse = await client.operations.walletItemTransfer.acceptWalletItemTransfer(walletItemTransfer.transferSlug, walletItemTransfer.transferSecret);
        expect(acceptResponse.error).toBeUndefined();
        expect(acceptResponse.object).toBeTruthy();
        const resultWithSecretAccepted = await findWalletItemTransferRecipientInfoByTransferSlug(walletItemTransfer.transferSlug, walletItemTransfer.transferSecret);
...
//# sourceMappingURL=findWalletItemTransferRecipientInfoByTransferSlug.spec.js.map