...
export interface Db {
    close: () => Promise<void>;
    count: <T extends Model = Model>(query: MangoQuery<T>, modelType: ModelType) => Promise<QueryResult<number>>;
    countByMatch: <T extends Model = Model>(match: Partial<T>, modelType: ModelType) => Promise<QueryResult<number>>;
    ...
    findOneByMatch: <T extends Model = Model>(match: Partial<T>, modelType: ModelType) => Promise<QueryResult<T>>;
    findOne: <T extends Model = Model>(query: MangoQuery<T>, modelType: ModelType) => Promise<QueryResult<T>>;
