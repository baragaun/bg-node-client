...
export interface Operations {
    ...
    channel: {
        ...
        findMyChannels: (options: FindObjectsOptions, queryOptions?: QueryOptions) => Promise<QueryResult<Channel>>;
        findMyChannelsV2: (participantLimit: number | undefined, addLatestMessage: boolean | undefined, options: FindObjectsOptions, queryOptions?: QueryOptions) => Promise<QueryResult<ChannelListItem>>;
    ...
    walletItem: {
        ...
        findWalletItemById: (id: string, options: FindObjectsOptions) => Promise<QueryResult<WalletItem>>;
    ...
    walletItemTransfer: {
        ...
        updateWalletItemTransferShowOnlineFlag: (transferSlug: string, transferSecret: string, showOnline: boolean) => Promise<QueryResult<void>>;
        findWalletItemTransferRecipientInfoByTransferSlug: (transferSlug: string, transferSecret?: string | null) => Promise<QueryResult<WalletItemTransferRecipientInfo>>;
