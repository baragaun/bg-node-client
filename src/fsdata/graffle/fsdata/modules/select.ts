...
export namespace Select {
  ...
  export type Query<$SelectionSet extends $$SelectionSets.Query> =
    $$Utilities.DocumentBuilder.InferResult.Operation<
      $SelectionSet,
      $$Schema.Schema,
  ...
  export type ChannelInboxItemMessage<
    $SelectionSet extends $$SelectionSets.ChannelInboxItemMessage,
  > = $$Utilities.DocumentBuilder.InferResult.OutputObjectLike<
    $SelectionSet,
    $$Schema.Schema,
  ...
  export type ChannelInboxItemInvitation<
    $SelectionSet extends $$SelectionSets.ChannelInboxItemInvitation,
  > = $$Utilities.DocumentBuilder.InferResult.OutputObjectLike<
    $SelectionSet,
    $$Schema.Schema,
