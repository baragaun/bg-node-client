...
n: "UserInput",
fcs: ["events", "metadata", "createdAt", "updatedAt", "deletedAt", "phoneNumberUpdatedAt", "emailUpdatedAt", "preferences", "signedInAt", "signedOutAt", "latestActivityAt", "inactivatedAt", "termsAndConditionsAcceptedAt", "suspendedAt", "companies", "groupMemberships", "company", "academicExperiences", "businessExperiences", "profileRoleHistory"],
f: {
id: {
...
n: "UserListFilter",
fcs: ["createdAtFrom", "createdAtUntil", "updatedAtFrom", "updatedAtUntil", "createdAtGreaterThan", "latestActivityAtGreaterThan"],
f: {
ids: {
...
n: "UserDeviceInput",
fcs: ["events", "metadata", "createdAt", "updatedAt", "deletedAt", "phoneNumberUpdatedAt", "signedInAt", "signedOutAt", "sessionStartedAt", "sessionEndedAt", "oauthTokenCreatedAt", "oauthTokenExpiresAt", "oauthRefreshTokenCreatedAt", "oauthRefreshTokenExpiresAt", "trustedAt"],
f: {
id: {
...
n: "ChannelInput",
fcs: ["events", "metadata", "createdAt", "updatedAt", "deletedAt", "statuses", "pausedAt", "suspendedAt", "archivedAt", "syncedWithMm2At"],
f: {
id: {
...
fcs: ["events", "metadata", "createdAt", "updatedAt", "deletedAt", "statuses", "editedAt", "suspendedAt", "syncedWithMm2At"],
f: {
id: {
...
fcs: ["events", "metadata", "createdAt", "updatedAt", "deletedAt", "dismissedFromInboxBySenderAt", "dismissedFromInboxByRecipientAt", "readByRecipientAt", "suspendedAt", "syncedWithMm2At"],
f: {
id: {
...
n: "ContentTagInput",
fcs: ["events", "metadata", "createdAt", "updatedAt", "deletedAt", "moderationConcern", "allModerationConcerns", "approvedByRecipientAt", "verifiedAt", "dismissedAt"],
f: {
id: {
...
n: "NotificationInput",
fcs: ["events", "metadata", "createdAt", "updatedAt", "deletedAt", "emailSentAt", "inAppMessageSentAt", "inAppMessageReceivedAt", "pushNotificationSentAt", "smsSentAt", "context"],
f: {
id: {
...
fcs: ["events", "metadata", "createdAt", "updatedAt", "deletedAt", "notificationSentAt", "emailUpdatedAt", "emailVerifiedAt", "errors", "passwordResettedAt", "passwordUpdatedAt", "phoneNumberUpdatedAt", "phoneNumberVerifiedAt", "signedInAt", "expiresAt"],
f: {
id: {
