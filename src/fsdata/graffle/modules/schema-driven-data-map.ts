...
const GroupMembershipRole: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'GroupMembershipRole',
};

const ModelEventType: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'ModelEventType',
};

const OptionType: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'OptionType',
};

const UiLanguage: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'UiLanguage',
};

const MastercardCardType: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'MastercardCardType',
};

const ChannelMessageType: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'ChannelMessageType',
};

const ChannelInvitationStatus: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'ChannelInvitationStatus',
};

const UserIdentType: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'UserIdentType',
};
...
const AppFeature: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'AppFeature',
};

const NotificationType: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'NotificationType',
};

const IdentityProvider: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'IdentityProvider',
};

const ModelType: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'ModelType',
};

const UploadedAssetType: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'UploadedAssetType',
};

const AssetHostingService: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'AssetHostingService',
};

const UserProfileRole: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'UserProfileRole',
};

const AppAction: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'AppAction',
};

const ChannelType: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'ChannelType',
};

const ChannelParticipantRole: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'ChannelParticipantRole',
};

const ModerationConcernType: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'ModerationConcernType',
};

const GroupRuleEventType: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
...
const AdminTaskType: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'AdminTaskType',
};

const AdminTaskResult: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'AdminTaskResult',
};

const ChannelInvitationDirection: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
...
const UserSearchFieldOption: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'UserSearchFieldOption',
};

const UserSearchSubscriptionType: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'UserSearchSubscriptionType',
};

const ServiceRequestType: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'ServiceRequestType',
};

const ServiceRequestResult: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'ServiceRequestResult',
};

const ServiceRequestMessageId: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'ServiceRequestMessageId',
};

const ErrorCode: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'ErrorCode',
};

const ServiceRequestSource: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'ServiceRequestSource',
};

const MultiStepActionType: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'MultiStepActionType',
};

const MultiStepActionStatus: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'MultiStepActionStatus',
};

const NotificationMethod: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'NotificationMethod',
};

const MultiStepActionResult: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
...
const ReportUserReasonTextId: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
...
const NotificationTemplateName: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'NotificationTemplateName',
};

const Mm2SyncDirection: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'Mm2SyncDirection',
};

const Mm2ModelType: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'Mm2ModelType',
};

const Mm2SynchronizationMode: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'Mm2SynchronizationMode',
};

const SyncRunMode: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'SyncRunMode',
};

const Mm2SynchronizerLogLevel: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'Mm2SynchronizerLogLevel',
};

const SyncActionTaken: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'SyncActionTaken',
};

const ChannelChangedEventType: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
  n: 'ChannelChangedEventType',
};

const ObjectChangedEventType: $$Utilities.SchemaDrivenDataMap.Enum = {
  k: 'enum',
...
const FindObjectsOptions: $$Utilities.SchemaDrivenDataMap.InputObject = {
...
const SortItem: $$Utilities.SchemaDrivenDataMap.InputObject = {
  n: 'SortItem',
  f: {
    field: {},
    direction: {},
...
const FindUserByIdentOptions: $$Utilities.SchemaDrivenDataMap.InputObject = {
...
const UserInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
  n: 'UserInput',
  fcs: [
    'events',
    'metadata',
...
const ModelEventInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
  n: 'ModelEventInput',
  fcs: ['time'],
  f: {
    time: {
...
const BaseModelMetadataInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
...
const LabeledStringValueInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
...
const UserPreferencesInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
...
const NotificationOptionsInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
...
const GroupMembershipInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
...
const UserDeviceInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
  n: 'UserDeviceInput',
  fcs: [
    'events',
    'metadata',
...
const UserDeviceListFilter: $$Utilities.SchemaDrivenDataMap.InputObject = {
...
const UploadedAssetInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
...
const UploadedAssetListFilter: $$Utilities.SchemaDrivenDataMap.InputObject = {
...
const ChannelInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
  n: 'ChannelInput',
  fcs: [
    'events',
    'metadata',
...
const BgChannelStatusInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
...
const ChannelListFilter: $$Utilities.SchemaDrivenDataMap.InputObject = {
  n: 'ChannelListFilter',
  fcs: ['createdAtFrom', 'createdAtUntil', 'updatedAtFrom', 'updatedAtUntil'],
  f: {
    ids: {},
...
const ChannelMessageInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
...
const ChannelMessageStatusInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
...
const ChannelMessageListFilter: $$Utilities.SchemaDrivenDataMap.InputObject = {
...
const GroupMembershipListFilter: $$Utilities.SchemaDrivenDataMap.InputObject = {
...
const AppliedGroupRuleInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
...
const GroupRuleBaseConfigInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
...
const GroupListFilter: $$Utilities.SchemaDrivenDataMap.InputObject = {
  n: 'GroupListFilter',
  fcs: ['createdAtFrom', 'createdAtUntil', 'updatedAtFrom', 'updatedAtUntil'],
  f: {
    ids: {},
...
const SignInUserInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
  n: 'SignInUserInput',
  f: {
    authType: {},
    ident: {},
...
const SignInOauthUserInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
...
const AdminTaskInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
  n: 'AdminTaskInput',
...
const ChannelInvitationInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
...
const ContentTagInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
  n: 'ContentTagInput',
  fcs: [
    'events',
    'metadata',
...
const ModerationConcernInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
...
const GenRequest: $$Utilities.SchemaDrivenDataMap.InputObject = {
  n: 'GenRequest',
  fcs: ['events', 'metadata', 'createdAt', 'updatedAt', 'deletedAt', 'users', 'groups'],
  f: {
    id: {},
    adminNotes: {},
    events: {
    ...
    messageCount: {},
    users: {
      // nt: GenUserInput, <-- Assigned later to avoid potential circular dependency.
    },
    groups: {
      // nt: GenGroupsInput, <-- Assigned later to avoid potential circular dependency.
    },
    publishAppEvents: {},
  },
};

const GenUserInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
  n: 'GenUserInput',
  fcs: ['events', 'metadata', 'createdAt', 'updatedAt', 'deletedAt'],
  f: {
    id: {},
...
const GenGroupsInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
  n: 'GenGroupsInput',
  fcs: ['events', 'metadata', 'createdAt', 'updatedAt', 'deletedAt', 'specificGroups'],
  f: {
    id: {},
    adminNotes: {},
    events: {
    ...
    count: {},
    specificGroups: {
      // nt: GenSpecificGroupInput, <-- Assigned later to avoid potential circular dependency.
    },
  },
};

const GenSpecificGroupInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
  n: 'GenSpecificGroupInput',
  fcs: ['events', 'metadata', 'createdAt', 'updatedAt', 'deletedAt', 'groupRules', 'matchingEngine'],
  f: {
    id: {},
    adminNotes: {},
    events: {
    ...
    menteeCount: {},
    groupRules: {
      // nt: GenGroupRuleInput, <-- Assigned later to avoid potential circular dependency.
    },
    matchingEngine: {
      // nt: GenMatchingEngineInput, <-- Assigned later to avoid potential circular dependency.
    },
  },
};

const GenGroupRuleInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
  n: 'GenGroupRuleInput',
  fcs: ['events', 'metadata', 'createdAt', 'updatedAt', 'deletedAt'],
  f: {
    id: {},
...
const GenMatchingEngineInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
  n: 'GenMatchingEngineInput',
  fcs: ['events', 'metadata', 'createdAt', 'updatedAt', 'deletedAt'],
  f: {
    id: {},
    adminNotes: {},
...
const MastercardGroupMembershipInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
...
const SupportChannelConfigInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
...
const Mm2SynchronizationInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
  n: 'Mm2SynchronizationInput',
  fcs: ['events', 'metadata', 'createdAt', 'updatedAt', 'deletedAt', 'expiresAt'],
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const SidMultiStepActionInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
...
const MultiStepActionErrorInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
...
const UserIdentInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
  n: 'UserIdentInput',
  f: {
    userId: {},
    userIdent: {},
...
const UserTrackingInput: $$Utilities.SchemaDrivenDataMap.InputObject = {
  n: 'UserTrackingInput',
  fcs: ['events', 'metadata', 'createdAt', 'updatedAt', 'deletedAt'],
  f: {
    id: {},
...
const UserMetadata: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    updatedAt: {
      nt: DateTimeISO,
    },
...
const ChannelsUserMetadata: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    mentoringSessionCount: {},
  },
};

const GroupsUserMetadata: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    groupCount: {},
    updatedAt: {
      nt: DateTimeISO,
...
const GroupMembership: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const ModelEvent: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    time: {
      nt: DateTimeISO,
    },
...
const Expertise: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const Option: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const Industry: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const MenteesGroupMembership: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const MentorsGroupMembership: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const MastercardGroupMembership: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const IqlaaGroupMembership: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const CompanyType: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const EducationLevel: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const Gender: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const Pronoun: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const UserInbox: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const ChannelInbox: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    userId: {},
    unseenMessages: {
...
const ChannelInboxItemMessage: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    channelId: {},
    replyToMessageId: {},
...
const User: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    ...
    relationships: {
      // nt: UserRelationship, <-- Assigned later to avoid potential circular dependency.
    },
    inactivatedAt: {
      nt: DateTimeISO,
    },
...
const LabeledStringValue: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    label: {},
    value: {},
    tags: {},
...
const UserPreferences: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const NotificationOptions: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    notificationType: {},
    enableEmail: {},
    enableInAppMessage: {},
...
const UserDeviceWithoutAuth: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const UserBlock: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    userId: {},
    reasonTextId: {},
    notes: {},
...
const UserRelationship: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const Company: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const AcademicExperience: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const BusinessExperience: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const UploadedAsset: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const Notification: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const NotificationContext: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    title: {},
    senderId: {},
    senderFirstName: {},
...
const Channel: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const ChannelMetadata: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    updatedAt: {
      nt: DateTimeISO,
    },
...
const ChannelInvitation: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const ChannelMessageMetadata: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    updatedAt: {
      nt: DateTimeISO,
    },
...
const ChannelMessageStatus: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    userId: {},
    receivedAt: {
      nt: DateTimeISO,
...
const ChannelParticipant: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const EndorsementWithTypes: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const ModerationConcern: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const ContentTagType: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const Group: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const AppliedGroupRule: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const GroupRuleBaseConfig: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const AdminTask: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const AdminTaskDef: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    adminTaskType: {},
    label: {},
    description: {},
...
const AdminTaskArgDef: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    name: {},
    label: {},
    dataType: {},
...
const ErrorCodeOption: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const IndonesianCity: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const IndonesianProvince: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const IqlaaJordanianDistrict: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const MastercardBank: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const UserSearchFilter: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    searchText: {},
    seeksHelp: {},
    offersHelp: {},
...
const UserSearchRunInfo: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    topUserIds: {},
    userCount: {},
    matchCount: {},
...
const UserWithScore: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    createdAt: {
      nt: DateTimeISO,
...
const Mm2Integration: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const SidMultiStepAction: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const MultiStepActionError: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const ReportUserReason: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const Training: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const TrainingContentPage: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const TrainingSession: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const ContentTag: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const SupportChannelConfig: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const NotificationTemplate: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const Mm2Synchronization: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
    ...
    logLevel: {},
    result: {
      // nt: Mm2SynchronizationResult, <-- Assigned later to avoid potential circular dependency.
    },
    duration: {},
    itemCount: {},
    pace: {},
...
const Mm2SynchronizationResult: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    items: {
      // nt: Mm2SynchronizationResultItem, <-- Assigned later to avoid potential circular dependency.
    },
    createdCount: {},
    deletedCount: {},
    updatedCount: {},
...
const Mm2SynchronizationResultItem: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const ObjectChangedEvent: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    serviceRequest: {
      // nt: ServiceRequest, <-- Assigned later to avoid potential circular dependency.
    },
...
const BaseModel: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    id: {},
    adminNotes: {},
    events: {
...
const BaseModelMetadata: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    ...UserMetadata.f,
  },
};

const IGroupMembership: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    ...GroupMembership.f,
...
const Query: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    ...
    getMm2Integration: {
      // nt: Mm2Integration, <-- Assigned later to avoid potential circular dependency.
    },
...
const Mutation: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    ...
    createMm2Synchronization: {
      a: {
        input: {
          nt: Mm2SynchronizationInput,
          it: [1],
        },
      },
      // nt: Mm2Synchronization, <-- Assigned later to avoid potential circular dependency.
    },
    deleteMm2Synchronization: {
      a: {
        mm2SynchronizationId: {
          nt: String,
          it: [1],
        },
      },
...
const Subscription: $$Utilities.SchemaDrivenDataMap.OutputObject = {
  f: {
    channelChanged: {
      a: {
        channelId: {
...
GenRequest.f!['events']!.nt = ModelEventInput;
GenRequest.f!['metadata']!.nt = BaseModelMetadataInput;
GenRequest.f!['users']!.nt = GenUserInput;
GenRequest.f!['groups']!.nt = GenGroupsInput;
GenUserInput.f!['events']!.nt = ModelEventInput;
GenUserInput.f!['metadata']!.nt = BaseModelMetadataInput;
GenGroupsInput.f!['events']!.nt = ModelEventInput;
GenGroupsInput.f!['metadata']!.nt = BaseModelMetadataInput;
GenGroupsInput.f!['specificGroups']!.nt = GenSpecificGroupInput;
GenSpecificGroupInput.f!['events']!.nt = ModelEventInput;
GenSpecificGroupInput.f!['metadata']!.nt = BaseModelMetadataInput;
GenSpecificGroupInput.f!['groupRules']!.nt = GenGroupRuleInput;
GenSpecificGroupInput.f!['matchingEngine']!.nt = GenMatchingEngineInput;
GenGroupRuleInput.f!['events']!.nt = ModelEventInput;
GenGroupRuleInput.f!['metadata']!.nt = BaseModelMetadataInput;
GenMatchingEngineInput.f!['events']!.nt = ModelEventInput;
GenMatchingEngineInput.f!['metadata']!.nt = BaseModelMetadataInput;
...
Mm2SynchronizationInput.f!['events']!.nt = ModelEventInput;
Mm2SynchronizationInput.f!['metadata']!.nt = BaseModelMetadataInput;
...
User.f['relationships']!.nt = UserRelationship;
...
UserRelationship.f['events']!.nt = ModelEvent;
UserRelationship.f['metadata']!.nt = BaseModelMetadata;
...
Mm2Integration.f['events']!.nt = ModelEvent;
Mm2Integration.f['metadata']!.nt = BaseModelMetadata;
...
MyUser.f['relationships']!.nt = UserRelationship;
...
Mm2Synchronization.f['events']!.nt = ModelEvent;
Mm2Synchronization.f['metadata']!.nt = BaseModelMetadata;
Mm2Synchronization.f['result']!.nt = Mm2SynchronizationResult;
Mm2SynchronizationResult.f['items']!.nt = Mm2SynchronizationResultItem;
Mm2SynchronizationResultItem.f['events']!.nt = ModelEvent;
Mm2SynchronizationResultItem.f['metadata']!.nt = BaseModelMetadata;
...
Query.f['getMm2Integration']!.nt = Mm2Integration;
...
Mutation.f['createMm2Synchronization']!.nt = Mm2Synchronization;
Mutation.f['deleteMm2Synchronization']!.nt = Mm2Synchronization;
Mutation.f['findMm2SynchronizationById']!.nt = Mm2Synchronization;
Mutation.f['runMm2Synchronization']!.nt = Mm2Synchronization;
...
const $schemaDrivenDataMap: $$Utilities.SchemaDrivenDataMap = {
  ...
  types: {
    ...
    Mm2SyncDirection,
    Mm2ModelType,
    Mm2SynchronizationMode,
    SyncRunMode,
    Mm2SynchronizerLogLevel,
    SyncActionTaken,
    ...
    GenUserInput,
    GenGroupsInput,
    GenSpecificGroupInput,
    GenGroupRuleInput,
    GenMatchingEngineInput,
