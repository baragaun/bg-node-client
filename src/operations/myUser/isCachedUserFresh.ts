...
const isCachedUserFresh = async (): Promise<boolean> => {
  try {
    ...
    logger.debug('isCachedUserFresh: comparing timestamps.',
      { local: localUpdatedAt, remote: clientInfo.remoteContentStatus.myUserUpdatedAt });
