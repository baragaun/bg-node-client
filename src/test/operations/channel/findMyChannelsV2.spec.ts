...
describe.runIf(isFeatureEnabled('channels'))('operations.channel.findMyChannelsV2', () => {
  ...
  test('returns the channels for the current user', async () => {
    ...
    const queryResultFromNetwork = await client.operations.channel.findMyChannelsV2(
      4,
      true,
      undefined,
    ...
    const queryResultFromLocal = await client.operations.channel.findMyChannelsV2(
      4,
      true,
      undefined,
