...
describe('operations.myUser.updateMyUser', () => {
  ...
  test('should update the user', async () => {
    ...
    expect(findMyUserFromCacheResult1.object).toBeTruthy();
    expect(myUserFromCache).toBeTruthy();
    ...
    expect(myUserFromNetworkResult.object).toBeTruthy();
    ...
    expect(findMyUserFromCacheResult2.object).toBeTruthy();
