...
export const translate = (
  key: string,
  uiMessageType: UiMessageType = UiMessageType.appErrorCode,
...
export const getUiMessages = (): typeof uiMessages => {
  return uiMessages;
}

export const setUiMessages = (newMessages: typeof uiMessages): void => {
